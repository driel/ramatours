...
class Users extends CI_Controller {
  ...
  function save_user() {
    filter_access("Asset Handover", "add");
    $user = new User();
    $staff = new Staff();
  ...
  function update_user(){
    filter_access("Asset Handover", "edit");
    $user = new User();
  ...
  function delete($id) {
    filter_access("Asset Handover", "delete");
    $user = new User();
    $user->_delete($id);
    redirect('users/index');
  }
