...
<link rel="stylesheet" type="text/css"
	href="<?php echo base_url(); ?>assets/application.css" />
<link rel="stylesheet" type="text/css"
	href="<?php echo base_url(); ?>assets/css/fullcalendar.css" />
		...
		<div class="sidebar">
			<div class="nContainer">
				...
				<ul class="navigation">
						...
						<ul>
							<li><a href="#" class="blblue">Master</a>
								...
								<ul class="grand-sub-menu">
									...
									<li><?php echo anchor('taxes_employees', 'Taxes Employees'); ?>
									</li>
									<li><?php echo anchor('employees_status', 'Employees Status'); ?>
									</li>
									<li><?php echo anchor('maritals_status', 'Marital Status'); ?>
									</li>
							...
							<li><a href="#" class="blyellow">Transaction</a>
								...
								<ul class="grand-sub-menu">
									...
									<li><?php echo anchor('assets_handover', 'Serah Terima Asset')?>
									</li>
								</ul>
							</li>
							<li><a href="#" class="blorange">Reporting</a>
								...
								<ul class="grand-sub-menu">
									...
									<li><?php echo anchor('components/report_detail', 'Detil Gaji Karyawan'); ?>
									</li>
									<li><?php echo anchor('components/report_slip', 'Slip Gaji'); ?>
									</li>
									<li><?php echo anchor('staffs/report_pph', 'Rekap PPh Karyawan'); ?>
									</li>
									<li><?php echo anchor('assets/report_list', 'List Asset'); ?></li>
									<li><?php echo anchor('assets_handover/report', 'Asset Detail'); ?>
									</li>
									<li><?php echo anchor('staffs/report_cuti', 'Sisa Cuti'); ?></li>
									<li><?php echo anchor('staffs/report_expired_doc', 'Expired Document'); ?>
									</li>
					...
					<li><a href="#" class="blyellow">Ticketing</a>
						<div class="open"></div>
						<ul>
							<li><a href="#" class="blblue">Master</a>
								<div class="open"></div>
