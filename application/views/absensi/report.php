...
$(document).ready(function(){
  	$("#printPDF").click(function() {
  		document.location.href = '<?php echo site_url('absensi/report').'?'.$_SERVER['QUERY_STRING'].'&to=pdf'; ?>';
  	});

  	$("#printXLS").click(function() {
  		document.location.href = '<?php echo site_url('absensi/report').'?'.$_SERVER['QUERY_STRING'].'&to=xls'; ?>';
  	});
});
</script>
<div class="body">
